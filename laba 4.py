...
ax1 = plt.subplot(311)
plt.bar(np.arange(n),a1, color = "red", label = "макс значение")
plt.bar(np.arange(n),b1, color = "blue", label = "мин значение")
plt.bar(np.arange(n),c1, color = "green",label = "среднее значение")
plt.legend()
plt.ylabel('Значение')
plt.xlabel('Строка')
...
ax2 = plt.subplot(312)
plt.plot(a2, color = "red",  label = "макс значение")
plt.plot(b2, color = "blue",  label = "мин значение")
plt.plot(c2, color = "green",  label = "среднее значение")
plt.xlabel('Строка')
plt.ylabel('Значение')
...
ax3 = plt.subplot(313)
plt.bar(np.arange(n), c3, color='yellow')
plt.plot(np.arange(n),c3, color='green', marker='o', markersize=3, label = "ср значение")
plt.bar(np.arange(n), a3, color='yellow')
plt.plot(np.arange(n),a3, color = "red", marker = ">", label = "макс значение")
plt.bar(np.arange(n), b3, color='yellow')
plt.plot(np.arange(n),b3, color = "blue", marker = ">", label = "мин значение")
plt.xlabel('Строка')
plt.ylabel('Значение')
